"""
Grabbite — utils/page_builders.py
Plan 4 refactor: static data blobs extracted from blueprints/public.py.

Exports:
  _static_offers  — dict of static promotional offer cards (used on /offer/<id>)
  _DISHES         — dict of static gallery dish catalogue (used on /gallery and /dish/<id>
                    and in blueprints/api/search.py for gallery search)
"""
...
# Used by /gallery, /dish/<id>, and blueprints/api/search.py gallery search.
# ─────────────────────────────────────────────────────────────────────────────
_DISHES = {
    # ── Curries & Mains ────────────────────────────────────────────────────
